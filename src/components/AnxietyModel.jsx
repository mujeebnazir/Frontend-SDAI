...
import useAnxietyPrediction from '../hooks/useAnxiety.js';
      ...
      <div className="relative z-40 max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Complete this comprehensive assessment to predict anxiety using our ML model trined on local <span className='blue_gradient'>Kashmiri</span> data.
          </p>
        </div>
        ...
        <div className="relative z-30 bg-white rounded-lg shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-center">
              ...
              >
                {loading ? 'Predicting...' : 'Predict Anxiety Level'}
              </button>
            </div>
          </form>
